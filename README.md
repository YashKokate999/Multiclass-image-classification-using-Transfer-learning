[README.md](https://github.com/user-attachments/files/29865091/README.md)
...
The notebook plots training vs. validation accuracy and loss curves, and reports final evaluation accuracy and loss on the validation set.
